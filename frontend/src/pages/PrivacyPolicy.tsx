          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="text-gray-700 mb-4">
                SwampTok ("we", "our", or "us") is committed to protecting your
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                to us when you register on our platform, including:
              </p>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                have certain data protection rights. SwampTok aims to take
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                17 ("Adult"). We do not knowingly collect personally
                identifiable information from Children under 17. If you become
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                contact us at{" "}
                <a
                  href="mailto:swamptok.help@gmail.com"
                  className="text-blue-600 hover:underline"
                >
                  swamptok.help@gmail.com
                </a>
                .
              </p>
            </section>
